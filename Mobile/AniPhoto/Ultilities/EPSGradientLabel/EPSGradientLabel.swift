...
// MARK: - EPSGradientLabel Definition

@objcMembers
open class EPSGradientLabel: UILabel {
    ...
    private enum GradientType: Codable {
        ...
        init(from decoder: Decoder) throws {
            ...
            default:
                fatalError("Invalid gradient type")
            }
        }
    }
            ...
            if let gradient = gradient {
                ...
                case let .radial(startCenter, startRadius, endCenter, endRadius, radiiScalingRule):
                    ...
                    context.drawRadialGradient(gradient,
                                               startCenter: CGPoint(x: startCenter.x * size.width, y: startCenter.y * size.height),

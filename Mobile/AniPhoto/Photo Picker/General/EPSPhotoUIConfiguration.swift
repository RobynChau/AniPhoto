//
//  EPSPhotoUIConfiguration.swift
//  AniPhoto
//
//  Created by PhatCH on 2022/4/18.
//
...
@objcMembers
public class EPSPhotoUIConfiguration: NSObject {
    @objc public enum CancelButtonStyle: Int {
        case text
        case image
    }
    
    private static var single = EPSPhotoUIConfiguration()
    
    public class func `default`() -> EPSPhotoUIConfiguration {
        return EPSPhotoUIConfiguration.single
    }
    
    public class func resetConfiguration() {
        EPSPhotoUIConfiguration.single = EPSPhotoUIConfiguration()
    }
    ...
    public var style: AniPhotoStyle = .embedAlbumList
    
    public var statusBarStyle: UIStatusBarStyle = .lightContent
    
    /// text: Cancel.  image: 'x'. Defaults to image.
    public var navCancelButtonStyle: EPSPhotoUIConfiguration.CancelButtonStyle = .image
    ...
    public var hudStyle: EPSProgressHUD.Style = .dark
    ...
    public var customAlertClass: EPSCustomAlertProtocol.Type?
    ...
    public var languageType: EPSLanguageType = .system {
        didSet {
    ...
    /// 框架主题色
    public var themeColor: UIColor = .eps.rgba(0, 193, 94)
    ...
    /// 相册列表及小图界面导航条背景色
    public var navBarColor: UIColor = .eps.rgba(140, 140, 140, 0.75)
    
    /// A color for navigation bar in preview interface.
    /// 预览大图界面的导航条背景色
    public var navBarColorOfPreviewVC: UIColor = .eps.rgba(50, 50, 50)
    ...
    public var navEmbedTitleViewBgColor: UIColor = .eps.rgba(80, 80, 80)
    
    /// A color for background in album list.
    /// 相册列表背景色
    public var albumListBgColor: UIColor = .eps.rgba(45, 45, 45)
    ...
    /// 相册列表数量label的颜色
    public var albumListCountColor: UIColor = .eps.rgba(180, 180, 180)
    
    /// A color for album list separator.
    /// 相册列表分割线颜色
    public var separatorColor: UIColor = .eps.rgba(60, 60, 60)
    
    /// A color for background in thumbnail interface.
    /// 相册小图界面背景色
    public var thumbnailBgColor: UIColor = .eps.rgba(25, 25, 25)
    ...
    /// 相册小图界面底部工具条背景色
    public var bottomToolViewBgColor: UIColor = .eps.rgba(35, 35, 35, 0.3)
    
    /// A color for background in bottom tool view in preview interface.
    /// 预览大图界面底部工具条背景色
    public var bottomToolViewBgColorOfPreviewVC: UIColor = .eps.rgba(35, 35, 35, 0.3)
    
    /// Title color of the original image size label in the album thumbnail interface.
    /// 相册小图界面原图大小label的text颜色
    public var originalSizeLabelTextColor: UIColor = .eps.rgba(130, 130, 130)
    
    /// Title color of the original image size label in the preview interface.
    /// 预览大图界面原图大小label的text颜色
    public var originalSizeLabelTextColorOfPreviewVC: UIColor = .eps.rgba(130, 130, 130)
    ...
    public var bottomToolViewBtnDisableTitleColor: UIColor = .eps.rgba(168, 168, 168)
    
    /// The disable state title color of bottom tool view done button.
    /// 相册小图界面底部 `完成` 按钮不可交互状态下标题颜色
    public var bottomToolViewDoneBtnDisableTitleColor: UIColor = .eps.rgba(168, 168, 168)
    ...
    public var bottomToolViewBtnDisableTitleColorOfPreviewVC: UIColor = .eps.rgba(168, 168, 168)
    
    /// The disable state title color of bottom tool view done button  in preview interface.
    /// 预览大图界面底部 `完成` 按钮不可交互状态下标题颜色
    public var bottomToolViewDoneBtnDisableTitleColorOfPreviewVC: UIColor = .eps.rgba(168, 168, 168)
    ...
    public var bottomToolViewBtnDisableBgColor: UIColor = .eps.rgba(50, 50, 50)
    
    /// The disable state background color of bottom tool view buttons in preview interface.
    /// 预览大图界面底部按钮不可交互状态下背景色
    public var bottomToolViewBtnDisableBgColorOfPreviewVC: UIColor = .eps.rgba(50, 50, 50)
    ...
    /// 不可选的照片上方遮罩阴影颜色
    public var invalidMaskColor: UIColor = .eps.rgba(32, 32, 32, 0.85)
    
    /// The text color of selected cell index label.
    /// 已选照片右上角序号label背景色
    public var indexLabelTextColor: UIColor = .eps.rgba(220, 220, 220)
    ...
    /// 相册小图界面拍照按钮背景色
    public var cameraCellBgColor: UIColor = .eps.rgba(76, 76, 76)
    ...
    public var imageEditorToolTitleNormalColor: UIColor = .eps.rgba(160, 160, 160)
    ...
    /// 编辑器中垃圾箱普通状态下的颜色
    public var trashCanBackgroundNormalColor: UIColor = .eps.rgba(40, 40, 40, 0.8)
    
    /// Background tint color of trash can in image editor.
    /// 编辑器中垃圾箱高亮状态下的颜色
    public var trashCanBackgroundTintColor: UIColor = .eps.rgba(241, 79, 79, 0.98)
}
...
@objc public enum AniPhotoStyle: Int {
...
enum ZLCustomLanguageDeploy {
    static var language: EPSLanguageType = .system

//
//  EPSEmbedAlbumListView.swift
//  AniPhoto
//
//  Created by PhatCH on 2020/9/7.
//

import UIKit
import Photos

class EPSEmbedAlbumListView: UIView {
    static let rowH: CGFloat = 60
    
    private var selectedAlbum: EPSAlbumListModel
    ...
    private lazy var tableView: UITableView = {
        ...
        view.rowHeight = EPSEmbedAlbumListView.rowH
    ...
    private func setupUI() {
        ...
        backgroundColor = .eps.embedAlbumListTranslucentColor
    ...
    private func calculateBgViewBounds() -> CGRect {
        let contentH = CGFloat(arrDataSource.count) * EPSEmbedAlbumListView.rowH
...
extension EPSEmbedAlbumListView: UIGestureRecognizerDelegate {
...
extension EPSEmbedAlbumListView: UITableViewDataSource, UITableViewDelegate {

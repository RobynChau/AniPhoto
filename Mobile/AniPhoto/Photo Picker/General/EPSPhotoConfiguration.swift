...
@objcMembers
public class EPSPhotoConfiguration: NSObject {
    public typealias Second = Int
    
    public typealias KBUnit = CGFloat
    
    private static var single = EPSPhotoConfiguration()
    
    public class func `default`() -> EPSPhotoConfiguration {
        EPSPhotoConfiguration.single
    }
    
    public class func resetConfiguration() {
        EPSPhotoConfiguration.single = EPSPhotoConfiguration()
    }
    ...
    public var maxEditVideoTime: EPSPhotoConfiguration.Second = 10
    
    /// Allow to choose the maximum duration of the video. Defaults to 120.
    public var maxSelectVideoDuration: EPSPhotoConfiguration.Second = 120
    
    /// Allow to choose the minimum duration of the video. Defaults to 0.
    public var minSelectVideoDuration: EPSPhotoConfiguration.Second = 0
    
    /// Allow to choose the maximum data size of the video. Defaults to infinite.
    public var maxSelectVideoDataSize: EPSPhotoConfiguration.KBUnit = .greatestFiniteMagnitude
    
    /// Allow to choose the minimum data size of the video. Defaults to 0 KB.
    public var minSelectVideoDataSize: EPSPhotoConfiguration.KBUnit = 0
    
    /// Image editor configuration.
    public var editImageConfiguration = EPSImageEditorConfiguration()
    
    /// Whether to use custom camera. Defaults to true.
    public var useCustomCamera = true
    
    /// The configuration for camera.
    public var cameraConfiguration = EPSCameraConfiguration()

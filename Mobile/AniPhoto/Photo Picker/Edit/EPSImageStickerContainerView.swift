//
//  EPSImageStickerContainerView.swift
//  Example
//
//  Created by PhatCH on 2020/11/20.
//

import UIKit

@objcMembers
public class EPSImageStickerContainerView: UIView, ZLImageStickerContainerDelegate {
    ...
    public override func layoutSubviews() {
        ...
        let path = UIBezierPath(roundedRect: CGRect(x: 0, y: 0, width: self.frame.width, height: EPSImageStickerContainerView.baseViewH), byRoundingCorners: [.topLeft, .topRight], cornerRadii: CGSize(width: 8, height: 8))
    ...
    func setupUI() {
        ...
        self.baseView.snp.makeConstraints { (make) in
            ...
            make.bottom.equalTo(self.snp.bottom).offset(EPSImageStickerContainerView.baseViewH)
            make.height.equalTo(EPSImageStickerContainerView.baseViewH)
        }
...
extension EPSImageStickerContainerView: UIGestureRecognizerDelegate {
...
extension EPSImageStickerContainerView: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {

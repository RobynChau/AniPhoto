...
//  ZLPhotoBrowser
//
//  Created by PhatCH on 2020/8/22.
//
...
public extension AniPhotoWrapper where Base: UIImage {
    static func animateGifImage(data: Data) -> UIImage? {
        ...
        let maxFrameCount = EPSPhotoConfiguration.default().maxFrameCountForGIF
...
public extension AniPhotoWrapper where Base: UIImage {
    ...
    func resize(_ size: CGSize, scale: CGFloat? = nil) -> UIImage? {
        ...
        return UIGraphicsImageRenderer.eps.renderImage(size: size) { format in
    ...
    func clipImage(angle: CGFloat, editRect: CGRect, isCircle: Bool) -> UIImage {
        ...
        let temp = UIGraphicsImageRenderer.eps.renderImage(size: editRect.size) { format in
...
public extension AniPhotoWrapper where Base: UIImage {
    ...
    func adjust(brightness: Float, contrast: Float, saturation: Float) -> UIImage? {
        ...
        filter?.setValue(EPSImageEditorConfiguration.AdjustTool.brightness.filterValue(brightness), forKey: EPSImageEditorConfiguration.AdjustTool.brightness.key)
        filter?.setValue(EPSImageEditorConfiguration.AdjustTool.contrast.filterValue(contrast), forKey: EPSImageEditorConfiguration.AdjustTool.contrast.key)
        filter?.setValue(EPSImageEditorConfiguration.AdjustTool.saturation.filterValue(saturation), forKey: EPSImageEditorConfiguration.AdjustTool.saturation.key)
        let outputCIImage = filter?.outputImage
        return outputCIImage?.eps.toUIImage()
    }
}
...
public extension AniPhotoWrapper where Base: UIImage {
    ...
    func fillColor(_ color: UIColor) -> UIImage {
        return UIGraphicsImageRenderer.eps.renderImage(size: base.size) { format in
...
extension AniPhotoWrapper where Base: UIImage {
...
public extension AniPhotoWrapper where Base: CIImage {
